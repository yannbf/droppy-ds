...
export const Spinner = ({ label = 'Loading', className, ...rest }: SpinnerProps) => (
  <div role="status" aria-label={label} className={cx('droppy-Spinner', className)} {...rest}>
    <svg
    ...
    >
      <g>
        <circle cx="95" cy="50" r="4" className="droppy-Spinner-dot droppy-Spinner-dot--1" />
        <circle cx="95" cy="50" r="4" className="droppy-Spinner-dot droppy-Spinner-dot--2" />
        <circle cx="95" cy="50" r="4" className="droppy-Spinner-dot droppy-Spinner-dot--3" />
      </g>
